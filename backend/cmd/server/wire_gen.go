...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	authService := service.NewAuthService(userRepository, groupRepository, subscriptionService, redeemCodeRepository, configConfig, settingService, emailService, turnstileService, emailQueueService, promoService)
