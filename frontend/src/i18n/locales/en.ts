export default {
  ...
  guide: {
    ...
    subtitle: 'Claude Code, CodeX and Gemini CLI Installation Guide',
    quickStart: 'Quick Start',
    officialCli: 'Official CLI Tool',
    powered: 'Powered',
    installCli: 'Install CLI',
    configureKey: 'Configure Key',
    startCoding: 'Start Coding',
    tutorial: 'Complete Installation Tutorial',
    ...
    visitNodejs: 'Visit',
    downloadLts: 'Download LTS version installer',
    runInstaller: 'Run installer with default settings',
    verifyInstall: 'Verify installation:',
    installClaudeCode: 'Install Claude Code CLI',
    configureApi: 'Configure API',
    getAuthToken: 'Get API Token',
    visitConsole: 'Visit',
    console: 'Console',
    andDo: ' and:',
    clickAddToken: 'Click "Add Token"',
    selectGroup: 'Select token group: ',
    dedicated: ' Dedicated',
    mustSelect: ' (Must select this group)',
    tokenName: 'Token name: Any name you prefer',
    quotaSuggestion: 'Quota: Set to unlimited',
    configureEnv: 'Configure Environment',
    importantNote: 'Important: ',
    replaceToken: 'Replace the Token below with your API key generated in the console!',
    configLocation: 'Config location: ',
    pasteYourToken: 'Paste your Token here',
    copyConfig: 'Copy Config',
    startClaudeCode: 'Start Claude Code',
    enterProjectDir: 'After configuration, enter your project directory:',
    thenRun: 'Then run:',
    firstStartNote: 'First run configuration:',
    selectTheme: 'Select your color theme',
    confirmSecurity: 'Confirm security prompts',
    useDefaultTerminal: 'Use default terminal settings',
    trustWorkDir: 'Trust working directory',
    startCodingNote: 'Start AI-assisted coding! 🚀',
    copy: 'Copy',
    copied: 'Copied!',
    enterpriseAi: 'Enterprise AI Coding Assistant',
    envPrep: 'Environment Prep',
    installConfig: 'Install & Config',
    sameAsClaudeCode: 'Installation is the same as Claude Code. Please refer to the Node.js installation steps above.',
    installCodex: 'Install CodeX CLI',
    getCodexToken: 'Get CodeX Dedicated API Token',
    important: 'Important: ',
    codexDifferentToken: 'CodeX requires a dedicated group token, different from Claude Code token!',
    createConfigDir: 'Create Config Directory',
    createConfigFile: 'Create Config File',
    createConfigToml: 'Create config.toml file:',
    createAuthJson: 'Create auth.json file:',
    pasteCodexToken: 'Paste CodeX dedicated group token key',
    startCodex: 'Start CodeX',
    firstRunConfig: 'First run configuration:',
    selectDevEnv: 'Select your development environment',
    configCodeGen: 'Configure code generation preferences',
    setGptLevel: 'Set GPT-5 reasoning level',
    startAiCoding: 'Start AI-assisted coding! 🚀',
    codingAssistant: 'Coding Assistant',
    installGemini: 'Install Gemini CLI Globally',
    configureGemini: 'Configure Gemini CLI',
    replaceGeminiToken: 'Replace GEMINI_API_KEY below with your Gemini CLI dedicated API key from the console!',
    createGeminiDir: 'Create .gemini Directory',
    createEnvFile: 'Create .env File',
    pasteGeminiToken: 'Paste Gemini CLI dedicated group token key',
    createSettingsJson: 'Create settings.json File',
    startGemini: 'Start Gemini CLI',
